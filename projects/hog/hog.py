...
def roll_dice(num_rolls, dice=six_sided):
    ...
    if 1 in dice_results:
        return 1
    else:
        sum = 0
        for re in dice_results:
            sum += re
...
def boar_brawl(player_score, opponent_score):
    ...
    difference = player_digit - opponent_ten_digit
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    take_turn_score = simple_update(num_rolls, player_score, opponent_score, dice)
    sus_score = sus_points(take_turn_score)
...
def play(strategy0, strategy1, update,
    ...
    while score0 <= goal or score1 <= goal:
        if who == 0:
            player0_roll_dice = strategy0(score0, score1)
            score0 = update(player0_roll_dice, score0, score1, dice)
        else:
